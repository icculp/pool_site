        ...
        <div className="App">
            ...
            <header className="App-header">
                ...
                <p>
					...
					<br />
					<iframe style="background: #15992b;" title="How-to iframe" src="https://stakada.io/embed/howto?pool_id=aa3f700fc539642a938fbcc8b0bb4a37c0fd6b5023fd412f89693aa2" width="100%" height="300" frameborder="0" scrolling="no"></iframe>
					<br />
